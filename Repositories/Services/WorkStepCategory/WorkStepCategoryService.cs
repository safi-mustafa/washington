...
{
    public class WorkStepCategoryService<CreateViewModel, UpdateViewModel, DetailViewModel> : BaseService<WorkStepCategory, CreateViewModel, UpdateViewModel, DetailViewModel>, IWorkStepCategoryService<CreateViewModel, UpdateViewModel, DetailViewModel>
        ...
        where UpdateViewModel : class, IBaseCrudViewModel, IIdentitifier, new()
    {
        ...
        private readonly ILogger<WorkStepCategoryService<CreateViewModel, UpdateViewModel, DetailViewModel>> _logger;
        private readonly IRepositoryResponse _response;

        public WorkStepCategoryService(ApplicationDbContext db, ILogger<WorkStepCategoryService<CreateViewModel, UpdateViewModel, DetailViewModel>> logger, IMapper mapper, IRepositoryResponse response, IActionContextAccessor actionContext) : base(db, logger, mapper, response)
        {
        ...
        //    catch (Exception ex)
        //    {
        //        _logger.LogError($"WorkStepCategoryService GetAll method threw an exception, Message: {ex.Message}");
        //        return Response.BadRequestResponse(_response);
        //    }
        //}

        public override async Task<Expression<Func<WorkStepCategory, bool>>> SetQueryFilter(IBaseSearchModel filters)
        {
            var searchFilters = filters as WorkStepCategorySearchViewModel;
