...
namespace Repositories.Common
{
        ...
        where UpdateViewModel : class, IBaseCrudViewModel, IIdentitifier, new()
    {
        ...
        public LocationService(ApplicationDbContext db, ILogger<LocationService<CreateViewModel, UpdateViewModel, DetailViewModel>> logger, IMapper mapper, IRepositoryResponse response, IActionContextAccessor actionContext) : base(db, logger, mapper, response)
        {
            _modelState = actionContext.ActionContext.ModelState;
            _db = db;
        }

        public override async Task<Expression<Func<Location, bool>>> SetQueryFilter(IBaseSearchModel filters)
        {
