...
namespace Repositories.Common.GuestService.Interface
{
    public interface IGuestService<CreateViewModel, UpdateViewModel, DetailViewModel> : IUserBaseService<CreateViewModel, UpdateViewModel, DetailViewModel>
