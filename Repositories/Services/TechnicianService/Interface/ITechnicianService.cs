...
namespace Repositories.Common.TechnicianService.Interface
{
    public interface ITechnicianService<CreateViewModel, UpdateViewModel, DetailViewModel> : IUserBaseService<CreateViewModel, UpdateViewModel, DetailViewModel>
