...
namespace DataLibrary.Migrations
{
    ...
    [Migration("20250817094607_TaskCategoriesTable")]
    partial class TaskCategoriesTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Models.CompanyInformation", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Models.CustomerProjectNotes", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("CustomerProjectNotes");
                });
            ...
            modelBuilder.Entity("Models.Equipment", b =>
                {
                    ...
                    b.Property<string>("UsefulLifeMonths")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Models.JobSite", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Models.OrderConfirmStatus", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Models.TaskCategory", b =>
                {
                    ...
                    b.Property<long?>("WorkStepCategoryId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Models.WorkStepCategory", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Models.CompanyContact", b =>
                {
                    b.HasOne("Models.CompanyInformation", "CompanyInformation")
            ...
            modelBuilder.Entity("Models.CustomerProjectNotes", b =>
                {
                    b.HasOne("Models.CustomerProject", "CustomerProject")
                        .WithMany()
            ...
            modelBuilder.Entity("Models.TaskCategory", b =>
                {
                    ...
                    b.HasOne("Models.WorkStepCategory", "WorkStepCategory")
                        .WithMany()
                        .HasForeignKey("WorkStepCategoryId");

                    b.Navigation("TaskType");

                    b.Navigation("WorkStepCategory");
                });
