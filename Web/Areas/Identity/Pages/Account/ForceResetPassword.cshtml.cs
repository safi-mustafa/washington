...
namespace Web.Areas.Identity.Pages.Account
{
    public class ForceResetPasswordModel : PageModel
    {
        ...
        public ForceResetPasswordModel(UserManager<ApplicationUser> userManager, IIdentityService identity)
        {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            {
                ModelState.AddModelError(string.Empty, "Your account status is inactive.");
                return Page();
            }
